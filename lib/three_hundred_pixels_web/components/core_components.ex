defmodule ThreeHundredPixelsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ThreeHundredPixelsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ThreeHundredPixelsWeb.Gettext, "errors", msg, opts)
    end
  end
